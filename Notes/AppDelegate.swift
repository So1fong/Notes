...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    {
        createContainer(completion:
            { container in
                self.container = container
                //let baseDbOperation = BaseDBOperation(notebook: notebook)
                //baseDbOperation.context = container.viewContext
                //baseDbOperation.backgroundContext = container.newBackgroundContext()
